...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  , ((modMask, xK_w ), spawn $ "$HOME/.xmonad/scripts/picom-toggle.sh")
  --, ((modMask, xK_c), spawn $ "evolution")
  ...
  , ((modMask, xK_p), spawn $ "scrot 'ArcoLinux-%Y-%m-%d-%s_screenshot_$wx$h.jpg' -e 'mv $f $$(xdg-user-dir PICTURES)'")
  , ((modMask, xK_o), spawn $ "maim -s /tmp/screenshot.png; $HOME/.xmonad/scripts/imgur.sh /tmp/screenshot.png | xclip -selection clipboard")
